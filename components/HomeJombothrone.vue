...
<v-card-text>
  <v-row class="mt-6">
    <v-col cols="12" sm="6" offset-md="1" class="pa-5">
      <p class="text-black text-h2 font-weight-black" >Accounting and Tax</p>
      <v-img width="100"  src="/blue_line_zig.svg"></v-img>

      <p style="margin-top: -30px" class="text-black text-h2 font-weight-black" >Solutions of <span class="text-blue">Illinois</span></p>
   ...
   <v-row dense>
    ...
    <v-col cols="12" sm="4"  class="pa-6">
      <v-card style="border-radius: 15px; border:5px solid #2196F3 "
              height="500"
